      ...
      <header className="sticky top-0 z-50 h-16 border-b border-white/70 bg-[rgba(244,252,249,0.88)] shadow-[0_10px_34px_rgba(15,118,110,0.10)] backdrop-blur-xl">
        ...
        <div className="mx-auto flex h-full w-full max-w-[1180px] items-center justify-between px-4 lg:px-8">
          ...
          <div className="flex min-w-0 items-center gap-1.5 lg:hidden">
            {!authReady ? (
              <div className="hidden h-9 w-[70px] rounded-full border border-slate-200 bg-white/70 min-[390px]:block" />
            ) : loggedIn ? (
              <WalletPill
                className="inline-flex h-9 max-w-[84px] min-w-0 items-center gap-1 overflow-hidden rounded-full border border-slate-200 bg-white px-2 text-[11px] font-semibold text-slate-700 min-[390px]:max-w-[104px] min-[390px]:px-2.5 min-[390px]:text-xs"
                iconSize={14}
                iconClassName="shrink-0 text-[#2563EB]"
              />
            ) : (
              <Link
                href="/login"
                aria-label="Get Started"
                className="inline-flex h-9 items-center gap-1 rounded-full bg-[#00433d] px-2.5 text-xs font-semibold !text-white min-[390px]:px-3"
              >
            ...
            <Link
              href="/connect-now"
              className="inline-flex h-9 shrink-0 items-center justify-center rounded-full bg-[#0f766e] px-2.5 text-[11px] font-semibold !text-white shadow-sm hover:bg-[#005c55] min-[390px]:px-3 min-[390px]:text-xs"
            ...
            <button
              type="button"
              className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#d8e7dd] bg-white/80 text-slate-700"
