...
export const metadata: Metadata = {
  ...
  description:
    "YoPartner is India's premium companionship platform for verified companions, private chat, voice conversations, video companionship, and trusted human connection.",
  keywords: [
