    ...
    questions: [
      {
        ...
        answer:
          "YoPartner is India's premium companionship platform for adults. Connect with verified companions through chat, voice calls, and video companionship.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "You can choose chat companionship, voice call companionship, and video companionship.",
      },
      {
        ...
        <div className="space-y-10">
          {filteredCategories.length === 0 ? (
            <div className="rounded-[28px] border border-[#e1e8e6] bg-white p-8 text-center shadow-[0_18px_60px_rgba(15,23,42,0.06)]">
              ...
              <p className="mt-2 text-sm text-[#667572]">Try searching for verification, privacy, payments, or sessions.</p>
            </div>
          ) : (
